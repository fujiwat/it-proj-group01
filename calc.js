...
{
 "use strict";
 var calc,Client,WebSharper,Obj,UI,HtmlModule,attr,Operators,Strings,Arrays,Templating,Runtime,Server,TemplateInstance,ProviderBuilder,Unchecked,calc_Templates,Slice,AttrProxy,Seq,Doc,Elt,JavaScript,Pervasives,AttrModule,System,Guid,Collections,List,Handler,Client$1,Templates,Attrs,DomUtility,Enumerator,View,Dictionary,HashSet,TemplateInitializer,Var$1,EventTarget,Node,JS,Updates,Snap,Numeric,Object,Var,CheckedInput,DictionaryUtil,T,ConcreteVar,SC$1,WindowOrWorkerGlobalScope,Docs,Array,DocElemNode,CharacterData,Abbrev,Fresh,Prepare,KeyCollection,An,Settings,Mailbox,List$1,T$1,Attrs$1,Dyn,ValueCollection,Docs$1,RunState,NodeSet,Concurrency,Anims,SC$2,HashSetUtil,SC$3,SC$4,BindVar,SC$5,SC$6,AppendList,String,DynamicAttrNode,Scheduler,Easing,AsyncBody,SC$7,CT,HashSet$1,Char,CancellationTokenSource,DomNodes,Error,OperationCanceledException,Lazy,SC$8,Queue,LazyExtensionsProxy,LazyRecord,Math,IntelliFactory,Runtime$1,console,Date;
 calc=Global.calc=Global.calc||{};
 Client=calc.Client=calc.Client||{};
 ...
 calc_Templates=Global.calc_Templates=Global.calc_Templates||{};
 ...
 {
  var op,onum,num,strNum,decimals,display,calculator,a,b,_this,p,i;
  function updateDisplayByStr(str)
  {
   var sNum,s,$5;
   sNum="";
   s="";
  ...
  {
   if(num===-Global.Infinity||num===Global.Infinity||Global.String(num)==="NaN")
  ...
  function O(o,u)
  {
   op!=null&&op.$==1?(num=(op.$0(onum))(num),updateDisplay()):void 0;
   onum=num;
   num=0;
   decimals=0;
   op={
  ...
  function btn(caption,cl,action)
  {
   return Doc.Element("button",[AttrProxy.Create("class",cl),AttrModule.Handler("click",function()
   {
    return function()
    {
     return action();
  ...
  function D(n)
  {
   NumKeyS.play();  // T.Fujiwara 2023.04.19.
   if(decimals===0)
    {
     num=10*num+n;
     updateDisplay();
  ...
  function digit(n)
  {
   return btn(Global.String(n),"D",function()
   {
    D(n);
   });
  }
  ...
  a=(b=(_this=new ProviderBuilder.New$1(),(_this.h.push({
   ...
   $0:"main",
   $1:calculator
  }),_this)),(p=Handler.CompleteHoles(b.k,b.h,[]),(i=new TemplateInstance.New(p[1],calc_Templates.main(p[0])),b.i=i,i))).get_Doc();
 ...
 calc_Templates.main=function(h)
 {
 ...
 SC$3.$cctor=function()
 {
  ...
  SC$3.IntApplyUnchecked=(g$1=BindVar.IntGetUnchecked(),(s$1=BindVar.IntSetUnchecked(),function(v)
  {
  ...
  SC$3.IntApplyChecked=(g$2=BindVar.IntGetChecked(),(s$2=BindVar.IntSetChecked(),function(v)
  {
  ...
  SC$3.FloatApplyUnchecked=(g$3=BindVar.FloatGetUnchecked(),(s$3=BindVar.FloatSetUnchecked(),function(v)
  {
  ...
  SC$3.FloatApplyChecked=(g$4=BindVar.FloatGetChecked(),(s$4=BindVar.FloatSetChecked(),function(v)
  {
 ...
 {
  SC$3.$cctor();
  return SC$3.BoolCheckedApply;
 };
 BindVar.IntApplyChecked=function()
 {
  SC$3.$cctor();
  return SC$3.IntApplyChecked;
 };
 BindVar.IntApplyUnchecked=function()
 {
  SC$3.$cctor();
  return SC$3.IntApplyUnchecked;
 };
 BindVar.FloatApplyChecked=function()
 {
  SC$3.$cctor();
  return SC$3.FloatApplyChecked;
 };
 BindVar.FloatApplyUnchecked=function()
 {
  SC$3.$cctor();
  return SC$3.FloatApplyUnchecked;
 };
